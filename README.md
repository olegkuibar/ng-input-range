...
![publish-to-npm](https://github.com/olegkuibar/ng-input-range/workflows/publish-to-npm/badge.svg?branch=main&event=deployment_status) ![integration-tests](https://github.com/olegkuibar/ng-input-range/workflows/integration-tests/badge.svg?branch=main&event=workflow_run) ![unit-tests](https://github.com/olegkuibar/ng-input-range/workflows/unit-tests/badge.svg?branch=main)
